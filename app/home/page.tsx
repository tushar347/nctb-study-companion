  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1160px] space-y-5">
        <header className="relative isolate overflow-hidden rounded-[32px] border border-white/80 bg-transparent p-4 shadow-[0_25px_70px_rgba(0,106,78,0.22)] sm:p-5">
          {/* Bangladesh flag-inspired green gradient */}
          <div
            aria-hidden="true"
            className="pointer-events-none absolute inset-0"
            style={{
              background:
                "linear-gradient(90deg, #BFE9D0 0%, #55B986 20%, #C5E6D7 39%, #F2C0C2 51%, #B3DCCC 68%, #278C69 100%)",
            }}
          />

          {/* Stronger Bangladesh green tint on both sides */}
          <div
            aria-hidden="true"
            className="pointer-events-none absolute inset-0"
            style={{
              background:
                "linear-gradient(90deg, rgba(0,106,78,0.48) 0%, rgba(0,106,78,0.20) 32%, rgba(0,106,78,0.03) 49%, rgba(0,106,78,0.18) 73%, rgba(0,106,78,0.48) 100%)",
            }}
          />

          {/* Bangladesh flag red disc */}
          <div
            aria-hidden="true"
            className="pointer-events-none absolute left-[52%] top-[-105px] h-[310px] w-[310px] -translate-x-1/2 rounded-full"
            style={{
              background:
          ...
          <div
            aria-hidden="true"
            className="pointer-events-none absolute inset-[1px] rounded-[31px] border border-white/35"
          />
